...
const giveupVBConfigWhenVersionChange = true;
...
Input.startPressVB = function(key) {
	...
	const DIR_MAP = { up: '上', down: '下', left: '左', right: '右' };
	const mappedKey = DIR_MAP[key] ?? key;
	if( DrillUp.g_COI_keys_pressed[mappedKey] == true ){
		DrillUp.g_COI_keys_pressedTime[mappedKey] = undefined;
		DrillUp.g_COI_keys_releasedTime[mappedKey] = undefined;
		DrillUp.g_COI_keys_doubleTime[mappedKey] = undefined;
	}			
	DrillUp.g_COI_keys_pressed[mappedKey] = true;			
	if( DrillUp.g_COI_keys_pressedTime[mappedKey] != undefined &&
		DrillUp.g_COI_keys_pressedTime[mappedKey] >= 1 ){
		DrillUp.g_COI_keys_doubleTime[mappedKey] = 0;
	}			
	DrillUp.g_COI_keys_pressedTime[mappedKey] = 0;						
...
Input.endPressVB = function(key) {
	...
	const DIR_MAP = { up: '上', down: '下', left: '左', right: '右' };
	const mappedKey = DIR_MAP[key] ?? key;
	DrillUp.g_COI_keys_pressed[mappedKey] = false;
	DrillUp.g_COI_keys_releasedTime[mappedKey] = 0;
	DrillUp.g_COI_keys_listenerTime = DrillUp.g_COI_keys_judgeTime + 5;
};
