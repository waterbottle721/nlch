...
Game_CharacterBase.prototype.isPositionBackOfA = function(ev) {
    this.debugShowDirections(ev);
    switch (ev.direction()) {
    case 2: // Event facing down
      return this.scrolledY() < ev.scrolledY();
    case 4: // Event facing left
      return this.scrolledX() > ev.scrolledX();
    case 6: // Event facing right
      return this.scrolledX() < ev.scrolledX();
    case 8: // Event facing up
      return this.scrolledY() > ev.scrolledY();
    }
    return false;
};
...
Game_CharacterBase.prototype.isPositionBackOf = function(ev) {
    ...
    switch (this.direction()) {
    case 1: // Down Left
      return ev.scrolledY() < this.scrolledY();
      break;
    case 2: // Down
      return ev.scrolledY() < this.scrolledY();
      break;
    case 3: // Down Right
      ...
      break;
    case 4: // Left
      return ev.scrolledX() > this.scrolledX();
      break;
    case 6: // Right
      return ev.scrolledX() < this.scrolledX();
      break;
