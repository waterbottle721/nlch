...
//== PARAMETERS ============================================================================
 ...
 TSR.Save.window_x       = 835;   //TSR.Save.getMaxPos(TSR.Save.window_x);
...
Window_FileCommand.prototype.createBackgroundSprite = function() {
    ...
    let com = this.mode(); 
    if (com === 'save') {
        this._backgroundSprite.bitmap = ImageManager.loadSystem('saveCommand'); 
    } else if (com === 'load') {
        this._backgroundSprite.bitmap = ImageManager.loadSystem('loadCommand'); 
    } else {
        this._backgroundSprite.bitmap = ImageManager.loadSystem('saveCommand');
    }
...
Window_FileCommand.prototype.makeCommandList = function() {
    ...
    if (com === 'load') {  
      //this.addCommand(this.getCommandName('delete'), 'delete', this.savedSlot()); 取消了删除功能
