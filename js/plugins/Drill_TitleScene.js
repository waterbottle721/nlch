...
Scene_Title.prototype.externalLinks = function() {
      ...
      if (match) {
		...
		if (Utils.isMobileDevice()) {
          window.open('https://www.patreon.com/c/nlch/home', '_system');
        } else {
          require('nw.gui').Shell.openExternal('https://www.patreon.com/c/nlch/home');
        } 		
...
Window_TitleCommand.prototype.makeCommandList = function() {
	...
	this.addCommand('externalLinks', 'Links'); // 追加外部链接
